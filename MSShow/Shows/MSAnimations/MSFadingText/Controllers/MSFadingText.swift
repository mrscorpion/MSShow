...
class MSFadingText: UIViewController {
...
//    @IBOutlet var backgroundImageView: UIImageView!
    ...
    override func viewDidLoad() {
        ...
        backgroundImageView = UIImageView(frame: CGRectMake(0, 0, CGRectGetWidth(self.view.frame), CGRectGetHeight(self.view.frame)))
